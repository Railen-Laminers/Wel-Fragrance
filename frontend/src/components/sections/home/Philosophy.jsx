            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
                    {pillars.map((pillar) => (
                        <div
                            key={pillar.number}
                            className="philosophy-card group relative p-8 lg:p-10 border border-old-gold/10 hover:border-old-gold/30 transition-all duration-700 bg-warm-white/70 dark:bg-charcoal/70 backdrop-blur-sm"
                        >
                            <div className="absolute top-0 left-0 w-12 h-12 border-t border-l border-old-gold/20 group-hover:border-old-gold/50 transition-colors duration-500" />
                            <div className="absolute bottom-0 right-0 w-12 h-12 border-b border-r border-old-gold/20 group-hover:border-old-gold/50 transition-colors duration-500" />

                            <span className="font-playfair text-6xl text-old-gold/10 group-hover:text-old-gold/20 transition-colors duration-500">
                                {pillar.number}
                            </span>
                            <h3 className="font-cormorant text-2xl lg:text-3xl text-dark-teal dark:text-warm-white mt-4 mb-4 group-hover:text-old-gold transition-colors duration-500">
                                {pillar.title}
                            </h3>
