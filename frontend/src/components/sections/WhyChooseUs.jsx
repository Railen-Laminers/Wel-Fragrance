...
const values = [
    { icon: FaFlask, title: '100% Pure Oil', description: 'Our fragrances are crafted with premium pure oils, ensuring lasting intensity and skin‑friendly wear.' },
    { icon: FaLeaf, title: 'Ethically Sourced', description: 'We partner with sustainable suppliers who respect nature and local communities.' },
    { icon: FaHands, title: 'Artisan Craftsmanship', description: 'Every blend is hand‑composed by experienced perfumers with a passion for storytelling.' },
    { icon: FaTag, title: 'Affordable Luxury', description: 'Experience world‑class scents at a fraction of the price, without compromising quality.' },
];
                    ...
                    {values.map((item, index) => (
                        <Reveal key={index} delay={0.1 * index}>
                            <div className="text-center group">
                                ...
                                <h3 className="font-playfair text-xl text-dark-teal dark:text-white font-light mb-2">{item.title}</h3>
